...
<body class="animsition page-login layout-full page-dark">
  ...
  <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
    <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
      <div class="brand">
        <a title="ilk sehifeye don" href="../../index.php">
        <img class="brand-img" src="../../aribalilogo.jpg" alt="aribali mentorship network">
        <h2 class="brand-text"> ƏSAS SƏHİFƏYƏ KEÇİD</h2>
        </a>
      </div>
      <p>BİLGİLƏRİ DAXİL EDİN</p>
      ...
      <p>
        ...
        if ($_GET['dur']=="exit") { 
         ...
         <h1 style="color:red;">ÇIXIŞ EDİLDİ!</h1>
<?php        }         ?>
</p>
