...
<div class="page">
	<div class="page-header">
		<h1 class="page-title">Məqalə Əlavə Etmə Paneli</h1>
	</div>
					...
					<div class="col-md-12 col-lg-12">
						...
						<form method="POST" action="#" enctype="multipart/form-data">
							<div class="example-wrap">
								...
								<input type="text" name="basliq" required="required" placeholder="Məqalə Başlıq Əlavə edin.." class="form-control round" id="inputRounded">
							</div>
							<div class="example-wrap">
								<h4 class="example-title">Məqaləyə Məzmun əlavə edin</h4>
							...
							<button type="submit" name="f_elave" class="btn btn-animate btn-animate-vertical btn-success">
